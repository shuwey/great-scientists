...
LABS = [
    ...
    },
    {
        ...
        "callout": "日心说预言了恒星视差，可这个角度小得可怜——最近的恒星也只有约 0.8 角秒。当年最好的仪器精度只有角分（约 60 角秒）量级，连 0.1 角秒都摸不到，星星那点摆动根本看不出来——这反倒成了反对日心说的理由。直到 1838 年，贝塞尔才测出第一颗恒星的视差。详见 <a href=\"detail/copernican.html\">哥白尼革命</a>。",
    },
]
