...
SPEC = {
  ...
  "about_body": "<h2>资料来源</h2><p>本子站内容依据公开史料与科学史通识编写，核心事实（生卒、贝格尔号航行、《物种起源》、自然选择）与主流科学史一致。历史图片均来自 Wikimedia Commons 公有领域资源。</p><h2>延伸阅读</h2><p>想深入：达尔文《物种起源》（On the Origin of Species）中译或节选；以及《贝格尔号航行记》。</p>",
  ...
  "pages": {
    ...
    "selection": {
      ...
      "sections": [
        ...
        {"id": "result", "h": "四、结果与误解", "body": "长期下来，种群逐渐适应 environment，新类型由此产生。注意：这不是“强者生存”，也不是生物“想”变成某种样子，而是环境替差异做了筛选。",
  ...
  "terms": {
    ...
    "hms-beagle": {"name": "小猎犬号", "cat": "历史", "short": "达尔文环球航行的船", "plain": "1831—1836 年，达尔文以随船博物学家的身份搭乘“小猎犬号”环球考察，目睹各地迥异的生物，是进化思想的重要起点。", "analogy": "这趟五年航行，像是把他送进了一座露天的“世界生物博物馆”。", "page": "evolution", "anchor": "#before", "related": ["darwin", "galapagos"]},
    ...
    "darwin": {"name": "查尔斯·达尔文", "cat": "历史", "short": "进化论的主要提出者", "plain": "英国博物学家，以贝格尔号航行观察为基础，提出以自然选择为核心的进化论，深刻改变了生物学与人类自我认知。", "analogy": "他像是把“生物为何这么多样”这个大问题，第一次讲成了可验证的故事。", "page": "evolution", "anchor": "#before", "related": ["evolution", "wallace"]},
