...
SPEC = {
  ...
  "bio": [
    ...
    "他一生高产却只活到 48 岁。今天所有的 radio、Wi-Fi、光纤，底层都是他写下的那组方程在起作用。"
  ],
  ...
  "timeline": [
    ...
    {"year": 1855, "id": "color", "title": "彩色摄影实验", "img": "color-photography.jpg", "alt": "最早的彩色照片", "fig": "用三原色叠出彩色。", "body": "他演示用红、绿、蓝三滤光底片合成彩色影像，是彩色摄影原理的早期实践。"},
