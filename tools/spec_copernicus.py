  ...
  "pages": {
    ...
    "revolutionibus": {
      ...
      "sections": [
        ...
        {"id": "math", "h": "三、用数学说话", "body": "哥白尼继承了古希腊“天球匀速圆周运动”的审美，用一圈套一圈的圆去拟合行星位置。他相信：自然的真理，必须能用几何与数字精确表达。",
    ...
    "earthmotion": {
      ...
      "sections": [
        ...
        {"id": "axis", "h": "三、地轴倾斜与四季", "body": "地轴是斜的（约 23.5°）——这不是后来才发现的：哥白尼的日心模型已经用这一点解释四季。正是这点倾斜，让南北半球在不同时间接收阳光多少不同，形成春夏秋冬；开普勒、牛顿后来又从力学上给出了完整的解释。",
