...
SPEC = {
  ...
  "pages": {
    ...
    "pasteurization": {
      ...
      "sections": [
        {"id": "what", "h": "一、它是什么", "body": "巴氏杀菌是把液体（酒、奶、果汁）加热到一定温度并保持片刻，再迅速冷却，杀死大部分致病与腐败微生物，却尽量保留营养与风味。",
         "fig": "pasteurization", "figalt": "加热杀菌", "figcap": "温热片刻，坏菌退场，好味留下。"},
    ...
    "vaccine": {
      ...
      "sections": [
        ...
        {"id": "legacy", "h": "四、疫苗的遗产", "body": "巴斯德开创的减毒思路，催生了后续多种疫苗。他创立的研究所至今仍在对抗传染病；而疫苗技术的持续发展，最终让天花这样的烈性传染病被彻底消灭。",
  ...
  "labs": [
    ...
    {"key": "heat", "kind": "graph", "icon": "🔥", "title": "巴氏杀菌：加热后存活陡降",
     ...
     "desc": "温度越高、时间越久，活下来的越少——这就是加热杀菌的原理。",
