...
(function () {
  ...
  var T = window.NEWTON_TERMS || {};
  var P = window.NEWTON_PAGES || {};
  ...
  function labGravity(lab) {
    ...
    function draw() {
      ...
      function ball(cx, rr, color, label, sub) {
        ...
        ctx.fillStyle = "#8B96AA"; ctx.font = "600 12.5px -apple-system, sans-serif";
  ...
  function labProjectile(lab) {
    ...
    function draw(progress) {
      ...
      ctx.stroke();
      ctx.fillStyle = "#F59F00"; ctx.font = "800 14px -apple-system, sans-serif";
